...
public interface I_PrintMixin {
   ...
   * @return
   */
  default I_PrintMixin print(Object message) {
   ...
   * @return
   */
  default I_PrintMixin print(String message) {
    System.out.println(message);
    return this;
  }
   ...
   * @return
   */
  default I_PrintMixin println(Object message) {
    System.out.println(message);
    return this;
  }
   ...
   * @return
   */
  default I_PrintMixin println(String message) {
    System.out.println(message);
    return this;
  }
